...
subtitle: "Pace University -- Doctoral programs in Psychology"
...
#| echo: false
# Add link to urls
df$link_youtube_spss <- paste0("<a href='", df$link_youtube_spss, "' target='_blank'>Watch Video</a>")
# Remove NAs
df$link_youtube_spss[which(grepl(x = df$link_youtube_spss , pattern = "href='NA'"))] <- NA

# Add link to urls
df$link_youtube_jasp <- paste0("<a href='", df$link_youtube_jasp, "' target='_blank'>Watch Video</a>")
# Remove NAs
df$link_youtube_jasp[which(grepl(x = df$link_youtube_jasp , pattern = "href='NA'"))] <- NA

# Add link to urls
df$link_youtube_R <- paste0("<a href='", df$link_youtube_R, "' target='_blank'>Watch Video</a>")
# Remove NAs
df$link_youtube_R[which(grepl(x = df$link_youtube_R , pattern = "href='NA'"))] <- NA

# Add link to urls
df$link_youtube_excel <- paste0("<a href='", df$link_youtube_excel, "' target='_blank'>Watch Video</a>")
# Remove NAs
