...
date: '2021-12-12'
slug: []
categories: [Psychometrics, Poisson models, Log-linear models, Item-Response Theory]
tags: []
excerpt: "In this paper, published in <a href=\"https://doi.org/10.1002/jocb.490\"><em>Journal of Creative Behavior</em></a>, we introduce new psychometric models for count/fluency tasks (tasks in which individuals have to provide many instances). Notably, we extent the Rasch Poisson Counts Model (RPCM) to account for variable discrimination (2-Parameter Poisson Counts Model) and to account for local dependencies/nuisance factors (Bifactor 2-Parameter Poisson Counts Model)."
links:
- icon: file-pdf
  icon_pack: fa
  name: PDF
  url: Publication_pdf/Myszkowski and Storme - 2021 - Accounting for Variable Task Discrimination in Div.pdf
---
...
Go to the journal page for this article [here](https://doi.org/10.1002/jocb.490\).

Download the PDF [here](/Publication_pdf/Myszkowski%20and%20Storme%20-%202021%20-%20Accounting%20for%20Variable%20Task%20Discrimination%20in%20Div.pdf).
