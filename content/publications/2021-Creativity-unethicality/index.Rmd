...
tags: []
excerpt: "In this paper, published in <a href=\"https://doi.org/10.1037/aca0000332\"><em>Psychology of Aesthetics, Creativity, and the Arts</em></a>, we provide a meta-analysis of correlations between (un)ethical behavior and creativity, notably controlling for how the constructs were measured -- which, as it turns out, is important when considering the heterogeneity of the findings."
links:
- icon: file-pdf
  icon_pack: fa
  name: PDF
...
Go to the journal page for this article [here](https://doi.org/10.1037/aca0000332\).

Download the PDF [here](/Publication_pdf/Storme%20et%20al.%20-%202020%20-%20Creativity%20and%20unethicality%20A%20systematic%20review%20a.pdf).
