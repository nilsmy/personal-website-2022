---
title: Psychometrics and Survey Methods Consulting
description: Psychometrics, survey methods, questionnaire development, scale validation, and statistical modeling consulting for research teams, organizations, and R&D groups.
type: page
layout: standard
...
My consulting builds on my academic work in psychometrics and measurement. I have authored a Cambridge Elements book on [item response theory for creativity measurement](/book/) and have published on topics including item response models, rating and judgment data, scale validation, and the measurement of creativity, aesthetic, and interpersonal skills.

Selected examples include work on [item response theory for creativity measurement](/book/), [the structure of empathy questionnaire scores](/publications/2017-questionnaire-cognitive-affective-empathy-two-or-five-dimensions/), [the French Ten-Item Personality Inventory](/publications/2016-psychometric-properties-of-the-french-ten-item-personality-inventory/), [item-response modeling of the Standard Progressive Matrices](/publications/2018-intelligence/), [modeling PISA creative-thinking judgments](/publications/2026-solving-paradox-gpcm-pisa-rating-instructions/), and [Bayesian item response models for fluency scores](/publications/2025-bayesian-log-linear-poisson-irt-brms-stan/).
...
<p class="pt3">
<a class="btn-links mr2 ba dib" href="/contact/"><i class="far fa-envelope fa-lg fa-fw mr2"></i>Get in touch</a>
</p>
